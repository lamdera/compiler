...
versionsComment :: B.Builder
versionsComment =
  "// Generated by " <> B.stringUtf8 Lamdera.Version.medium <> " which includes the following package replacements:\n"
  <> (
    PackageReplacements.versions
